...
import dragonfly.composeapp.generated.resources.font_montserrat_medium
import dragonfly.composeapp.generated.resources.font_montserrat_regular
import dragonfly.composeapp.generated.resources.font_montserrat_semibold
import dragonfly.composeapp.generated.resources.font_ocr_a_regular
    ...
    get() = Typography(
        header1 = WeightableTextStyle(
            regular = TextStyle(
                fontSize = 32.sp,
                lineHeight = 48.sp,
                fontFamily = FontFamily(Font(Res.font.font_montserrat_regular)),
                fontWeight = FontWeight(400)
            ),
            medium = TextStyle(
                fontSize = 32.sp,
                lineHeight = 48.sp,
                fontFamily = FontFamily(Font(Res.font.font_montserrat_medium)),
                fontWeight = FontWeight(500)
            ),
            bold = TextStyle(
                fontSize = 32.sp,
                lineHeight = 48.sp,
                fontFamily = FontFamily(Font(Res.font.font_montserrat_semibold)),
        ...
        card = TextStyle(
            fontSize = 10.sp,
            lineHeight = 15.sp,
            fontFamily = FontFamily(Font(Res.font.font_ocr_a_regular)),
            fontWeight = FontWeight(500)
        ),
