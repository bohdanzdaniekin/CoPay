...
import dragonfly.composeapp.generated.resources.content_description_hide
import dragonfly.composeapp.generated.resources.content_description_show
        ...
        IconButton(onClick = { isVisible = !isVisible }) {
            Icon(
                ...
                contentDescription = if (isVisible) {
                    stringResource(resource = Res.string.content_description_hide)
                } else {
                    stringResource(resource = Res.string.content_description_show)
                }
            )
        }
    }
